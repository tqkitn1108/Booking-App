...
const Navbar = () => {
  ...
  // Hàm tạo chữ cái đầu và màu nền từ thông tin người dùng
    ...
    const handleLogoutClick = (logoutType) => {
        if (logoutType === 'navigate') {
          ...
          // Perform any actions needed when setting currentUser to false
            ...
            <div className="home-nav-container">
                ...
                {currentUser ? (
                            ...
                            <div className="" tabIndex="-1" {...attrs}>
                                <div className="nav-menu-logout">
                                    <div className="nav-user-logout">
                                        ...
                                        <div className="user-logout-text" onClick={() => handleLogoutClick('navigate')}>Lịch sử đặt phòng</div>
                                    </div>
                                    <div className="nav-user-logout">
                                        <div className="user-logout-icon">
                                        ...
                                        <div className="user-logout-text" onClick={() => handleLogoutClick('setUserFalse')}>Đăng xuất</div>
                                    </div>
                                </div>
                            </div>
                        )}
                    ...
                    <div className="nav-user-button">
                        {renderAvatar(userName, avatarBackgroundColor)}
