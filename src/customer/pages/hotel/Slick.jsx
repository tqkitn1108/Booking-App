...
const CardSlick1 = () => {
    return (
      ...
      />   
                    <div>
                        <h5 className="trip-planner-titles"></h5>
                        <h5 className="trip-planner-desrcibe">Large room, good location close to beach with a good rooftop swimming pool which we used every day. Nice rain shower in the bathroom and breakfast was good considering only $40 Australian dollars per night for two people included in the price. Good secure entrance door lock on the room. Bed and pillows were very comfortable.</h5>
                    </div>
                </div>
            </SwiperSlide>
            <SwiperSlide>
      ...
      />
                    <div>
                        <h5 className="trip-planner-titles"></h5>
                        <h5 className="trip-planner-desrcibe">Nhân viên thật tuyệt vời! Rất nhiệt tình và thân thiện. Khách sạn rất sạch sẽ và phòng rộng lớn, đầy đủ mọi thứ chúng tôi cần.</h5>
                    </div>
                </div>
            </SwiperSlide>
            <SwiperSlide>
      ...
      />
                    <div>
                        <h5 className="trip-planner-titles"></h5>
                        <h5 className="trip-planner-desrcibe">Mọi thứ đều tốt và như mong đợi. Chỗ nghĩ có sẵn tủ lớn để giữ hành lí qua ngày và tự lấy chìa khóa tủ rất tiện nghi. Tuy là dạng căn hộ nhưng vẫn có các chị vào dọn vệ sinh và thay ga giường rất sạch sẽ.</h5>
                    </div>
                </div>
            </SwiperSlide>
            <SwiperSlide>
